...
const GamePanel = ({
  ...
  return (
    <>
      ...
      >
        <strong>Город:</strong>{' '}
        <span style={{ color: '#ffd700', fontSize: '20px' }}>{currentCity.name}</span>
      </p>
          ...
          <p style={{ margin: '0', fontSize: '16px' }}>
            ...
            <span
              style={{
                fontSize: '20px',
                fontWeight: 'bold',
                color: lastResult.earned_points < 0 ? '#ff6b6b' : '#ffd700',
              }}
            >
              {lastResult.earned_points}
            </span>
          </p>
        </div>
      )}
